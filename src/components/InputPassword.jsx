...
const InputPassword = ({ className = null, ...props }) => {

    const [isHidden, setIsHidden] = useState(true);

    return (
        <div className={`h-10 w-full rounded-md border-[1px] border-gray-300 bg-background flex flex-row justify-between ${className}`}>
            <input
